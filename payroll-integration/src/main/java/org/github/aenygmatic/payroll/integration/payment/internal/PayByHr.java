 ...
 */
package org.github.aenygmatic.payroll.integration.payment.internal;
...
@PaymentComponent({PayType.CASH, PayType.PAYCHECK})
public class PayByHr implements PayEmployee {
