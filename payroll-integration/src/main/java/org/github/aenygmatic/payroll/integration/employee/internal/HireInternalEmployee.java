...
@EmployeeComponent(EmployeeType.EMPLOYEE)
public class HireInternalEmployee implements HireEmployee {

    @Override
    public void hire(Employee e) {
        System.out.println(String.format("%-25s Hire: %-10s %-15s %-15s -- %s:%s", this.getClass().getSimpleName(), e.getName(), e.getPosition(), "(internal)", e.type(), e.payType()));
    }
}
